...
\title{Convex Variational Bayesian Learning}
%\author{
%Guillaume Bouchard\\\href{guillaume.bouchard@xerox.com}{\nolinkurl{guillaume.bouchard@xerox.com}}
%\and%\\
%Balaji Lakshminarayanan\\\href{balaji@gatsby.ucl.ac.uk}{\nolinkurl{balaji@gatsby.ucl.ac.uk}}}
%\date\today
...
\subsection{TRUNCATED MULTIVARIATE GAUSSIAN INTEGRATION}
...
\begin{eqnarray}
\Phi(\s) &=& \prod_{i=1}^m \int_{-\infty}^{s_i} \normdist(u_i|0,1) du_i 
\nonumber
\\&=&
\int_{\Re^m}
...
\nonumber\\
% &=&\int_{\Re^d}\int_{\Re^m} \Indic{\v \ge 0}  \normdist(\v|\Z\w,\eye_m) \normdist(\w|\zeros_d,\lambda\eye_d) d\v d\w
 && =\int_{\Re^{d}}\int_{\Re^{+m}} %\Indic{\v \ge 0} 
