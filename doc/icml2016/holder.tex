%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% arxiv
%\documentclass[reqno,oneside,letterpaper,10pt]{article}
%\usepackage[utf8]{inputenc} 
%\pdfoutput=1        
%%set paper width
%\usepackage{fullpage}
%%\usepackage[textwidth=142mm,textheight=214mm]{geometry} % used in MF paper
%\usepackage[textwidth=146mm,textheight=214mm]{geometry} % 
...
%%% ----- icml: start -------
\twocolumn[
\icmltitle{Approximate Inference with the Variational \Holder Bound}
...
\icmlkeywords{variational inference, convex optimization, holder inequality, approximate inference}
...
%\red{We present experiments on Bayesian probit regression and show that the parameter estimates obtained using the VH method closely approximate the parameter estimates obtained using the classic Albert and Chib auxiliary variable sampler.}
...
%%	 \nonumber
%%	 \\	 
%  	 + \frac 1{\alpha_2} J({\alpha_2}(A-\diag{\btau_1}), {\alpha_2}(b-\tau_2))  -\frac n2 \log (2\pi). %+ C
%\end{flalign}
 \begin{flalign} % icml
 \label{eq:obj}  
	%\frac 1{\alpha_1}  \sum_i  \log\Phi(\tau_{2i}\sqrt{\alpha_1/\tau_{1i}})  - n\mathcal{H}(\frac{1}{\alpha_1}) + C
&	\frac 1{\alpha_1}  \sum_i  \log\unigint{f_i}(\tau_{1i},\tau_{2i}, \alpha_1)    -\frac n2 \log (2\pi)
\nonumber	 \\ &
%	 \quad
	 %+ \frac 1{\alpha_1} J(\frac 1{\alpha_1}\diag{\btau_1}, \tau_2)   
%	 \nonumber
...
\begin{align}{
L &=  -\frac{1}{2}\trace(A \E{q}{\t\t\transp}) + \bm b\transp \E{q}{\t}  +\frac{n}{2}\log(2\pi e)  
\nonumber\\& \hspace{-0.2in}% icml
+\sum_i\Bigl( \log\bigl(\sigma_i \Phi(\frac{\mu_i}{\sigma_i})\bigr) - \frac{\mu_i}{ 2\sqrt{2\pi} \sigma_i \Phi(\frac{\mu_i}{\sigma_i}) } \exp(-\frac{1}{2}\frac{\mu_i^2}{\sigma_i^2}) \Bigr), \nonumber\\
...
\nonumber\\ \E{q}{t_i t_j} &= \E{q}{t_i} \E{q}{t_j} \forall i\neq j. % icml
}\end{align}
...
\begin{table}[h]%icml
\begin{center}
%\resizebox{0.99\columnwidth}{!}{ % arxiv
\begin{tabular}{|c|c|c|c|c|c|}
\hline
$\kappa$ & $n$ & Genz & EP & VB & VH \\
\hline
0.1&5&5.1499&5.1327&2.9489&6.4169\\%\hline
1&5&0.41768&0.41234&0.10715&0.98725\\\hline
0.1&20&24.7689&24.7702&17.5524&28.2854\\%\hline
1&20&1.9203&1.9196&0.97199&2.8037\\\hline
0.1&50&66.2055&66.1991&44.3699&68.971\\%\hline
1&50&9.9&9.8999&5.9196&11.2919\\\hline
\end{tabular}
%} % arxiv
...
\hline
$\kappa$ & $n$ & VB vs EP & VH vs EP & VB vs VH \\
\hline
0.1&5&1.9286&0.35811&1.7518\\%\hline
1&5&0.12856&0.073666&0.19735\\\hline
0.1&20&3.0963&3.3148&2.9741\\%\hline
1&20&0.19727&0.074579&0.27093\\\hline
0.1&50&5.5944&0.72705&5.9132\\%\hline
1&50&0.51551&0.076875&0.58154\\\hline
\end{tabular}
%}% arxiv
\end{center}
\caption{Comparison of log partition function (left) and error in first moment (right)}
\label{tab:results}
\end{table}
...
%\begin{tabular}{|c|c|c|c|c|}
%\hline
%$\kappa$ & $D$ & VB vs EP & VH vs EP & VB vs VH \\
%\hline
%0.1&5&1.9286&0.35811&1.7518\\%\hline
%1&5&0.12856&0.073666&0.19735\\\hline
%0.1&20&3.1386&9.0743&10.6134\\%\hline
%1&20&0.19727&0.074579&0.27093\\\hline
%0.1&50&5.5944&0.72705&5.9132\\%\hline
%1&50&0.51551&0.076875&0.58154\\\hline
%\end{tabular}
...
%$\kappa$ & $D$ & VB vs EP & VH vs EP & VB vs VH \\
%\hline
%0.1&5&26.8584&11.1634&16.0101\\%\hline
%1&5&2.4201&1.7695&0.70231\\\hline
%0.1&20&121.9444&38038.4911&38028.151\\%\hline
%1&20&11.5866&11.3471&0.74618\\\hline
%0.1&50&312.3578&299.5287&14.6838\\%\hline
%1&50&30.9008&30.7132&0.57631\\\hline
%\end{tabular}
%}
%\end{center}
%%\caption{Error in second moment}
%\caption{Error in first moment (left) and second moment (right)}
%\end{table}



%%%
\section{Experiments}  % on higher dimensional truncated Gaussian
...
of the target distribution. % and the second order moment (a $n\times n$ positive definite matrix) The comparison of moments is shown of~\ref{tab:moments}.
...
%%\clearpage
%\section{Experiments}  % on probit regression 
...
%We would like to thank the anonymous referees for helpful comments. BL acknowledges funding from the Gatsby charitable foundation. 
